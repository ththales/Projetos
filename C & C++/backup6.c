...
typedef struct {
    ...
    int level, hp, maxHp, def, maxDef, armaAtual, itemExtra, moedas, andar;
}Personagem;
...
void salvarJogo() {
    ...
    fprintf(p, "%s\n%s\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d", player.nome, player.classe, player.level, player.hp, player.maxHp, player.def, player.maxDef, player.armaAtual, player.itemExtra, player.andar, player.moedas);
    fclose(p);
}
